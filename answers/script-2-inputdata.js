...
document.getElementById('buffbutton').addEventListener('click', () => {
    ...
    // Use turf buffer function to create 0.5km buffer of input points
    // Assign buffer polygons to  empty featurecollection for buffers
    let buffresult = turf.buffer(geojson, 0.5);
